...
public class BlazingWastelandBiome extends EarthPulsationModElements.ModElement {
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-39936).setWaterColor(-8421569).setWaterFogColor(-8421569)
						.withSkyColor(-39936).withFoliageColor(-8421569).withGrassColor(-8421569)
						.setParticle(new ParticleEffectAmbience(ParticleTypes.LAVA, 0.005f)).build();
				...
				event.getRegistry().register(biome.setRegistryName("earth_pulsation:blazing_wasteland"));
			}
		}
	}
	@Override
