...
public class BlazingWastelandBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register(
				"earth_pulsation:tree_blazing_wasteland",
				FeatureUtils.register("earth_pulsation:tree_blazing_wasteland", Feature.TREE,
	...
	public static void init() {
		BiomeDictionary.addTypes(
				ResourceKey.create(Registry.BIOME_REGISTRY, BuiltinRegistries.BIOME.getKey(EarthPulsationModBiomes.BLAZING_WASTELAND.get())),
