...
public class DeepWellTeleporter implements ITeleporter {
	...
	public static void registerPointOfInterest(RegistryEvent.Register<PoiType> event) {
		poi = new PoiType("deep_well_portal",
				Sets.newHashSet(ImmutableSet.copyOf(EarthPulsationModBlocks.DEEP_WELL_PORTAL.getStateDefinition().getPossibleStates())), 0, 1)
	...
	public Optional<BlockUtil.FoundRectangle> createPortal(BlockPos p_77667_, Direction.Axis p_77668_) {
		...
		BlockState blockstate = EarthPulsationModBlocks.DEEP_WELL_PORTAL.defaultBlockState().setValue(NetherPortalBlock.AXIS, p_77668_);
