...
public class CobaltOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("earth_pulsation:cobalt_ore", FEATURE,
				new OreConfiguration(CobaltOreFeatureRuleTest.INSTANCE, EarthPulsationModBlocks.COBALT_ORE.get().defaultBlockState(), 8));
		PLACED_FEATURE = PlacementUtils.register("earth_pulsation:cobalt_ore", CONFIGURED_FEATURE,
	...
	private static class CobaltOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("earth_pulsation:cobalt_ore_match"), CUSTOM_MATCH);
		}
