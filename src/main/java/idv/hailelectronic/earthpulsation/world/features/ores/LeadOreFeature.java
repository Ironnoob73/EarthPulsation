...
public class LeadOreFeature extends OreFeature {
	public static final LeadOreFeature FEATURE = (LeadOreFeature) new LeadOreFeature().setRegistryName("earth_pulsation:lead_ore");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE
			.configured(new OreConfiguration(LeadOreFeatureRuleTest.INSTANCE, EarthPulsationModBlocks.LEAD_ORE.defaultBlockState(), 7))
	...
	private static class LeadOreFeatureRuleTest extends RuleTest {
		...
		static final RuleTestType<LeadOreFeatureRuleTest> CUSTOM_MATCH = Registry.register(Registry.RULE_TEST,
				new ResourceLocation("earth_pulsation:lead_ore_match"), () -> codec);
