...
public class NickelOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("earth_pulsation:nickel_ore", FEATURE,
				new OreConfiguration(NickelOreFeatureRuleTest.INSTANCE, EarthPulsationModBlocks.NICKEL_ORE.get().defaultBlockState(), 8));
		PLACED_FEATURE = PlacementUtils.register("earth_pulsation:nickel_ore", CONFIGURED_FEATURE,
	...
	private static class NickelOreFeatureRuleTest extends RuleTest {
		...
		private static final com.mojang.serialization.Codec<NickelOreFeatureRuleTest> CODEC = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		private static final RuleTestType<NickelOreFeatureRuleTest> CUSTOM_MATCH = () -> CODEC;

		@SubscribeEvent
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("earth_pulsation:nickel_ore_match"), CUSTOM_MATCH);
		}
		...
		public boolean test(BlockState blockAt, Random random) {
			if (base_blocks == null) {
				base_blocks = List.of(EarthPulsationModBlocks.YELLOW_STONE.get());
			}
