...
public class CopperAxeHeadItem extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:copper_axe_head")
	public static final Item block = null;
	public CopperAxeHeadItem(EarthPulsationModElements instance) {
		super(instance, 14);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("copper_axe_head");
		}
