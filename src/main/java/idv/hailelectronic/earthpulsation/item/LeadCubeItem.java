...
public class LeadCubeItem extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:lead_cube")
	public static final Item block = null;
	public LeadCubeItem(EarthPulsationModElements instance) {
		super(instance, 68);
	}
