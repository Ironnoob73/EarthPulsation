...
public class AluminumArmorItem extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:aluminum_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("earth_pulsation:aluminum_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("earth_pulsation:aluminum_armor_leggings")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(EarthPulsationItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "earth_pulsation:textures/models/armor/aluminum__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
