...
public class CopperHoeHeadItem extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:copper_hoe_head")
	public static final Item block = null;
	public CopperHoeHeadItem(EarthPulsationModElements instance) {
		super(instance, 24);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("copper_hoe_head");
		}
