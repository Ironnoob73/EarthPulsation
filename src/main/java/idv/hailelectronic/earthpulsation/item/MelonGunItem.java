...
import idv.hailelectronic.earthpulsation.entity.renderer.MelonGunRenderer;
import idv.hailelectronic.earthpulsation.EarthPulsationModElements;

@EarthPulsationModElements.ModElement.Tag
public class MelonGunItem extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:melon_gun")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(EarthPulsationItemGroup.tab).maxDamage(100));
			setRegistryName("melon_gun");
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ItemStack stack = ShootableItem.getHeldAmmo(entity, e -> e.getItem() == Items.MELON_SEEDS);
					if (stack == ItemStack.EMPTY) {
						for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
							ItemStack teststack = entity.inventory.mainInventory.get(i);
							if (teststack != null && teststack.getItem() == Items.MELON_SEEDS) {
								stack = teststack;
								break;
							}
						}
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						...
						if (entity.abilities.isCreativeMode) {
							...
							if (new ItemStack(Items.MELON_SEEDS).isDamageable()) {
