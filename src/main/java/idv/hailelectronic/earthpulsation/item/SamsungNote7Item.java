...
import idv.hailelectronic.earthpulsation.entity.renderer.SamsungNote7Renderer;
import idv.hailelectronic.earthpulsation.EarthPulsationModElements;

@EarthPulsationModElements.ModElement.Tag
public class SamsungNote7Item extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:samsung_note_7")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(EarthPulsationItemGroup.tab).maxDamage(1));
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Explosive"));
			list.add(new StringTextComponent("use with caution"));
			list.add(new StringTextComponent("\u6613\u7206"));
			list.add(new StringTextComponent("\u8C28\u614E\u4F7F\u7528"));
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(SamsungNote7Item.block);
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			Entity imediatesourceentity = this;
			{
				...
				SamsungNote7ExplotionProcedure.executeProcedure($_dependencies);
			}
		}
