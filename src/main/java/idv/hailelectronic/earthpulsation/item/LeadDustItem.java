...
public class LeadDustItem extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:lead_powder")
	public static final Item block = null;
	public LeadDustItem(EarthPulsationModElements instance) {
		super(instance, 74);
	}
