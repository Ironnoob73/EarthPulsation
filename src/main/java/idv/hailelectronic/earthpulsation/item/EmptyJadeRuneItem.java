...
public class EmptyJadeRuneItem extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:empty_jade_rune")
	public static final Item block = null;
	public EmptyJadeRuneItem(EarthPulsationModElements instance) {
		super(instance, 203);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("empty_jade_rune");
		}
