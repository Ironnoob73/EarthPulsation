...
public class AluminumPowderItem extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:aluminum_powder")
	public static final Item block = null;
	public AluminumPowderItem(EarthPulsationModElements instance) {
		super(instance, 31);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("aluminum_powder");
		}
