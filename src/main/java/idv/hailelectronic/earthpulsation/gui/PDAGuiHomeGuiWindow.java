...
@OnlyIn(Dist.CLIENT)
public class PDAGuiHomeGuiWindow extends ContainerScreen<PDAGuiHomeGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = PDAGuiHomeGui.guistate;
	CheckboxButton H;
	public PDAGuiHomeGuiWindow(PDAGuiHomeGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
