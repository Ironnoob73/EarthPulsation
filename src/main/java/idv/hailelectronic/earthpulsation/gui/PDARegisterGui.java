...
public class PDARegisterGui extends EarthPulsationModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public PDARegisterGui(EarthPulsationModElements instance) {
		super(instance, 498);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("pda_register"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, PDARegisterGuiWindow::new));
	}
	...
	public void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.openContainer instanceof GuiContainerMod) {
			...
			double z = entity.getPosZ();
			{
				...
				PDATickProcedure.executeProcedure($_dependencies);
			}
		}
	}
		...
		if (buttonID == 0) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				CloseProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 2) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				TestPageProcedure.executeProcedure($_dependencies);
			}
		}
	}
