...
public class PulverizewrBlock extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:pulverizewr")
	public static final Block block = null;
	public PulverizewrBlock(EarthPulsationModElements instance) {
		super(instance, 5);
	}
