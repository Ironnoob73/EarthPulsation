...
public class ContainerColumnBlock extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:container_column")
	public static final Block block = null;
	public ContainerColumnBlock(EarthPulsationModElements instance) {
		super(instance, 224);
	}
