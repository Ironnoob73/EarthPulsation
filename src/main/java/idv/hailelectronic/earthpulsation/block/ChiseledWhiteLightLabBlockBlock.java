...
public class ChiseledWhiteLightLabBlockBlock extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:chiseled_white_light_lab_block")
	public static final Block block = null;
	public ChiseledWhiteLightLabBlockBlock(EarthPulsationModElements instance) {
		super(instance, 233);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_white_light_lab_block");
		}
