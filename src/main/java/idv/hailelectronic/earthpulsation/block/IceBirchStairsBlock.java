...
public class IceBirchStairsBlock extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:ice_birch_stairs")
	public static final Block block = null;
	public IceBirchStairsBlock(EarthPulsationModElements instance) {
		super(instance, 131);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("ice_birch_stairs");
		}
