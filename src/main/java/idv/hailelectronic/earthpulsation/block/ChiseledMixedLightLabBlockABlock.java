...
public class ChiseledMixedLightLabBlockABlock extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:chiseled_mixed_light_lab_block_a")
	public static final Block block = null;
	public ChiseledMixedLightLabBlockABlock(EarthPulsationModElements instance) {
		super(instance, 235);
	}
