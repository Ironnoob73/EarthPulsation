...
public class IceBirchFenceBlock extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:ice_birch_fence")
	public static final Block block = null;
	public IceBirchFenceBlock(EarthPulsationModElements instance) {
		super(instance, 144);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("ice_birch_fence");
		}
