...
public class ChiseledBlueLightLabBlockBlock extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:chiseled_blue_light_lab_block")
	public static final Block block = null;
	public ChiseledBlueLightLabBlockBlock(EarthPulsationModElements instance) {
		super(instance, 234);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_blue_light_lab_block");
		}
