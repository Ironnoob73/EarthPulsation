...
public class WoodenHolderBlock extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:wooden_holder")
	public static final Block block = null;
	public WoodenHolderBlock(EarthPulsationModElements instance) {
		super(instance, 124);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(16, 15, 16, 0, 16, 0)).withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(0, 15, 0, 16, 16, 16)).withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(16, 15, 0, 0, 16, 16)).withOffset(offset.x, offset.y, offset.z);
				case WEST :
