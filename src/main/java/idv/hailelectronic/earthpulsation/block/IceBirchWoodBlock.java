...
import idv.hailelectronic.earthpulsation.procedures.StrippeIceBirchWoodProcedure;
...
public class IceBirchWoodBlock extends EarthPulsationModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("ice_birch_wood");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				StrippeIceBirchWoodProcedure.executeProcedure($_dependencies);
			}
