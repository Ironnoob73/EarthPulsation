...
public class IceBirchSlabBlock extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:ice_birch_slab")
	public static final Block block = null;
	public IceBirchSlabBlock(EarthPulsationModElements instance) {
		super(instance, 118);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("ice_birch_slab");
		}
