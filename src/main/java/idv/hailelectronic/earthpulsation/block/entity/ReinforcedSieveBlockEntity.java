...
public class ReinforcedSieveBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public ReinforcedSieveBlockEntity(BlockPos position, BlockState state) {
		super(EarthPulsationModBlockEntities.REINFORCED_SIEVE, position, state);
	}
	...
	public Component getDefaultName() {
		return new TextComponent("reinforced_sieve");
	}
	...
	public Component getDisplayName() {
		return new TextComponent("Reinforced Sieve");
	}
