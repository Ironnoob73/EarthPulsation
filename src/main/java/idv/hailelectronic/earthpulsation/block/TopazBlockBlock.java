...
public class TopazBlockBlock extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:topaz_block")
	public static final Block block = null;
	public TopazBlockBlock(EarthPulsationModElements instance) {
		super(instance, 99);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(5f, 8f).setLightLevel(s -> 0).harvestLevel(2)
