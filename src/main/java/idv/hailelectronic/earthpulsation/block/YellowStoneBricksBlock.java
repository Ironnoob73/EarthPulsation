...
public class YellowStoneBricksBlock extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:yellow_stone_bricks")
	public static final Block block = null;
	public YellowStoneBricksBlock(EarthPulsationModElements instance) {
		super(instance, 161);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("yellow_stone_bricks");
		}
