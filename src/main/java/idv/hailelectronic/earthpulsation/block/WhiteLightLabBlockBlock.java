...
public class WhiteLightLabBlockBlock extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:white_light_lab_block")
	public static final Block block = null;
	public WhiteLightLabBlockBlock(EarthPulsationModElements instance) {
		super(instance, 231);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("white_light_lab_block");
		}
