...
public class ContainerWallBlock extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:container_wall")
	public static final Block block = null;
	public ContainerWallBlock(EarthPulsationModElements instance) {
		super(instance, 225);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(16, 0, 16, 0, 16, 8)).withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(0, 0, 0, 16, 16, 8)).withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(16, 0, 0, 8, 16, 16)).withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(0, 0, 16, 8, 16, 0)).withOffset(offset.x, offset.y, offset.z);
				case UP :
					return VoxelShapes.or(makeCuboidShape(0, 16, 0, 16, 8, 16)).withOffset(offset.x, offset.y, offset.z);
				case DOWN :
