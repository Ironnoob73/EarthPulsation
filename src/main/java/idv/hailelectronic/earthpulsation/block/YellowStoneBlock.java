...
public class YellowStoneBlock extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:yellow_stone")
	public static final Block block = null;
	public YellowStoneBlock(EarthPulsationModElements instance) {
		super(instance, 140);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(YellowCobblestoneBlock.block));
		}
	}
}
