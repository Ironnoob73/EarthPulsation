...
public class ForgottenIronOreBlock extends EarthPulsationModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("forgotten_iron_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("earth_pulsation:forgotten_iron_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("forgotten_iron_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("earth_pulsation:forgotten_iron_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
