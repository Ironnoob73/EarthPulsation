...
import idv.hailelectronic.earthpulsation.procedures.StrippeIceBirchLogProcedure;
...
public class IceBirchLogBlock extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:ice_birch_log")
	public static final Block block = null;
	public IceBirchLogBlock(EarthPulsationModElements instance) {
		super(instance, 112);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				StrippeIceBirchLogProcedure.executeProcedure($_dependencies);
			}
