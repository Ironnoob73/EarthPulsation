...
public class BlazingDirtBlock extends EarthPulsationModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.EARTH).sound(SoundType.GROUND).hardnessAndResistance(1f, 1f).setLightLevel(s -> 0).harvestLevel(0)
