...
public class YellowCobblestoneSlabBlock extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:yellow_cobblestone_slab")
	public static final Block block = null;
	public YellowCobblestoneSlabBlock(EarthPulsationModElements instance) {
		super(instance, 132);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("yellow_cobblestone_slab");
		}
