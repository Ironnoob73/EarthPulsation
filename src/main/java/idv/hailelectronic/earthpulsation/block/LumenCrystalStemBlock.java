...
public class LumenCrystalStemBlock extends EarthPulsationModElements.ModElement {
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.GLASS).sound(SoundType.GLASS).hardnessAndResistance(2f, 2f).setLightLevel(s -> 10).harvestLevel(1)
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("earth_pulsation:lumen_crystal_stem_match"),
			...
			feature = new OreFeature(OreFeatureConfig.CODEC) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random rand, BlockPos pos, OreFeatureConfig config) {
					...
					if (dimensionType == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("earth_pulsation:deep_well")))
			...
			event.getRegistry().register(feature.setRegistryName("lumen_crystal_stem"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("earth_pulsation:lumen_crystal_stem"), configuredFeature);
		}
	}
	@SubscribeEvent
