...
public class BlueLightLabBlockBlock extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:blue_light_lab_block")
	public static final Block block = null;
	public BlueLightLabBlockBlock(EarthPulsationModElements instance) {
		super(instance, 232);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blue_light_lab_block");
		}
