...
public class IceBirchFenceGateBlock extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:ice_birch_fence_gate")
	public static final Block block = null;
	public IceBirchFenceGateBlock(EarthPulsationModElements instance) {
		super(instance, 119);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("ice_birch_fence_gate");
		}
