...
public class IceBirchPlanksBlock extends EarthPulsationModElements.ModElement {
	@ObjectHolder("earth_pulsation:ice_birch_planks")
	public static final Block block = null;
	public IceBirchPlanksBlock(EarthPulsationModElements instance) {
		super(instance, 141);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ice_birch_planks");
		}
