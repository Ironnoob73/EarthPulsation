...
public class RefinerGuiScreen extends AbstractContainerScreen<RefinerGuiMenu> {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("earth_pulsation:textures/refiner.png"));
		...
		if (POnProcedure.execute(world, x, y, z)) {
			...
			this.blit(ms, this.leftPos + 55, this.topPos + 38, 0, 0, 16, 16, 16, 16);
		}
		if (P25zProcedure.execute(world, x, y, z)) {
			...
			this.blit(ms, this.leftPos + 83, this.topPos + 37, 0, 0, 16, 16, 16, 16);
		}
