...
public abstract class PlayerEntity extends LivingEntity {
   ...
   public static AttributeModifierMap.MutableAttribute func_234570_el_() {
      return LivingEntity.registerAttributes().createMutableAttribute(Attributes.ATTACK_DAMAGE, 1.0D).createMutableAttribute(Attributes.MOVEMENT_SPEED, (double)0.1F).createMutableAttribute(Attributes.ATTACK_SPEED).createMutableAttribute(Attributes.LUCK).createMutableAttribute(net.minecraftforge.common.ForgeMod.REACH_DISTANCE.get()).createMutableAttribute(Attributes.ATTACK_KNOCKBACK);
   }
   ...
   public ITextComponent getDisplayName() {
      ...
      iformattabletextcomponent = iformattabletextcomponent.append(ScorePlayerTeam.func_237500_a_(this.getTeam(), this.displayname));
